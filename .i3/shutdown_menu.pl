...
my $options = "-width -30 -location 3 -dmenu -i -p \"$title\" -font 'font awesome 10' -theme ~/.cache/wal/colors-rofi-dark.rasi -lines 4"; # -color-window \'$color_window\' -color-normal \'$color_normal\' -font \'Inconsolata 11\'";
