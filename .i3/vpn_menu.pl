...
my $options = "-width -30 -location 3 -dmenu -i -p \"$title\" -lines 10 -theme ~/.cache/wal/colors-rofi-dark.rasi"; # -color-window \'$color_window\' -color-normal \'$color_normal\' -font \'Inconsolata 11\'";
my $menu = "";
