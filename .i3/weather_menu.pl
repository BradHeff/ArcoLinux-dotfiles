...
my $LANG = "EN";
my $CODE = "41930";
#'San Francisco Display Light 10'
my $titles = $CITY . " " . $COUNTRY;
my $options = "-width -30 -location 3 -dmenu -i -p \"$titles\" -lines 3 -font 'font awesome 10' -theme ~/.cache/wal/colors-rofi-dark.rasi"; #
...
sub get_weather {
	...
	$strs .= join( ' ', $title . $str1, $dot1[1], "C /", $dot1[0],"C\n" );
	...
	$strs .= join( ' ', $title . $str2, $dot2[1], "C /", $dot2[0],"C\n" );	
	chomp $strs;
